...
Please switch to ASTRAL-Pro2, as the current version of ASTRAL-Pro will no longer be maintained!
ASTRAL-Pro2, an equally accurate yet **faster** and **easier to install** version of A-pro with **lower memory consumption** is implemented in c++ [here](https://github.com/chaoszhang/ASTER/blob/master/tutorial/astral-pro.md) and published [here](https://doi.org/10.1093/bioinformatics/btac620).
